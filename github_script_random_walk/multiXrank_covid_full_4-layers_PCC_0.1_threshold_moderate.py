...
multixrank_obj = multixrank.Multixrank(config="config_full_covid_4-layers_PCC_0.1_threshold_moderate.yml", wdir="/cbio/users/francis_agamah/SOFT/multiXrank")
...
#ranking nodes
multixrank_obj.write_ranking(ranking_df, path="Output_Files/results_from_4_layers_PCC_0.1_threshold/moderate_hypothesis_driven/")

multixrank_obj.to_sif(ranking_df, path="Output_Files/results_from_4_layers_PCC_0.1_threshold/moderate_hypothesis_driven/seed_top3_full_4-layers_PCC_0.1_threshold_moderate_hypothesis_driven.sif", top=3)
